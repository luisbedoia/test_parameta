...
@XmlType(name = "EmployeeRegistrationRequest", propOrder = {"firstName", "lastName", "documentType",
    "documentNumber", "birthDate", "companyEntryDate", "position", "salary"})
@XmlRootElement(name = "EmployeeRegistrationRequest", namespace = EmployeeRegistrationRequest.NAMESPACE_URI)
